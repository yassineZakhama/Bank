...
public interface Bank {
     ...
     */
    void deleteAccount(String account) throws AccountDoesNotExistException, IOException, TransactionAlreadyExistException, AccountAlreadyExistsException, TransactionAttributeException;
